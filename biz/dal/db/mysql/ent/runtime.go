...
func init() {
	...
	surveyresponseDescMap := surveyresponseFields[8].Descriptor()
	...
	surveyresponseDescDevice := surveyresponseFields[9].Descriptor()
	...
	surveyresponseDescAudio := surveyresponseFields[10].Descriptor()
