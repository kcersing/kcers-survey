...
func (_q *AreaQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AreaQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *AreaQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AreaQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *AreaQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *AreaQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AreaQuery) Modify(modifiers ...func(s *sql.Selector)) *AreaSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *AreaSelect) Modify(modifiers ...func(s *sql.Selector)) *AreaSelect {
