...
var (
	...
	SysMenusColumns = []*schema.Column{
		...
		{Name: "icon", Type: field.TypeString, Nullable: true, Comment: "menu icon | 菜单图标", Default: ""},
	...
	SurveyResponseColumns = []*schema.Column{
		...
		{Name: "pic", Type: field.TypeJSON, Nullable: true, Comment: "照片/图片"},
		...
		{Name: "video", Type: field.TypeJSON, Nullable: true, Comment: "视频"},
		{Name: "file", Type: field.TypeJSON, Nullable: true, Comment: "文件"},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{SurveyResponseColumns[25]},
				RefColumns: []*schema.Column{SurveyColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
