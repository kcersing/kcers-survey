...
var CreateOrUpdateQuestionReq_Name_DEFAULT string = ""

func (p *CreateOrUpdateQuestionReq) GetName() (v string) {
	if !p.IsSetName() {
		return CreateOrUpdateQuestionReq_Name_DEFAULT
	}
	return p.Name
}

var CreateOrUpdateQuestionReq_Pic_DEFAULT string = ""

func (p *CreateOrUpdateQuestionReq) GetPic() (v string) {
	if !p.IsSetPic() {
		return CreateOrUpdateQuestionReq_Pic_DEFAULT
	}
	return p.Pic
}

var CreateOrUpdateQuestionReq_Link_DEFAULT string = ""

func (p *CreateOrUpdateQuestionReq) GetLink() (v string) {
	if !p.IsSetLink() {
		return CreateOrUpdateQuestionReq_Link_DEFAULT
	}
	return p.Link
}

var CreateOrUpdateQuestionReq_IsShow_DEFAULT int64 = 1

func (p *CreateOrUpdateQuestionReq) GetIsShow() (v int64) {
	if !p.IsSetIsShow() {
		return CreateOrUpdateQuestionReq_IsShow_DEFAULT
	}
	return p.IsShow
}
...
func (p *CreateOrUpdateQuestionReq) IsSetName() bool {
	return p.Name != CreateOrUpdateQuestionReq_Name_DEFAULT
}

func (p *CreateOrUpdateQuestionReq) IsSetPic() bool {
	return p.Pic != CreateOrUpdateQuestionReq_Pic_DEFAULT
}

func (p *CreateOrUpdateQuestionReq) IsSetLink() bool {
	return p.Link != CreateOrUpdateQuestionReq_Link_DEFAULT
}

func (p *CreateOrUpdateQuestionReq) IsSetIsShow() bool {
	return p.IsShow != CreateOrUpdateQuestionReq_IsShow_DEFAULT
}
...
type Options struct {
	Key   string `thrift:"key,1,optional" form:"key" json:"key" query:"key"`
...
var Options_Key_DEFAULT string = ""

func (p *Options) GetKey() (v string) {
	if !p.IsSetKey() {
		return Options_Key_DEFAULT
	}
	return p.Key
}

var Options_Value_DEFAULT string = ""

func (p *Options) GetValue() (v string) {
	if !p.IsSetValue() {
		return Options_Value_DEFAULT
	}
	return p.Value
}
...
func (p *Options) IsSetKey() bool {
	return p.Key != Options_Key_DEFAULT
}

func (p *Options) IsSetValue() bool {
	return p.Value != Options_Value_DEFAULT
}
