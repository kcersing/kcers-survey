...
const Lang = () => {
    ...
    return (<div className={styles.lang} data-lang>
    ...
    return (<div className={styles.container}>
      ...
      <div style={{
        ...
        <LoginForm contentStyle={{
            minWidth: 280,
            maxWidth: '75vw',
        }} logo={<img alt="logo" src="/logo.svg"/>} title="问卷调查" initialValues={{
            autoLogin: true,
          ...
          {setUserLoginState.code === 1 && (<LoginMessage content='账户或密码错误'/>)}
          {type === 'account' && (<>
