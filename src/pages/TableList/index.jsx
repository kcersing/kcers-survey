...
const TableList = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            renderFormItem: (item, { defaultRender, ...rest }, form) => {
                ...
                if (`${status}` === '3') {
                    return (<Input {...rest} placeholder={intl.formatMessage({
    ...
    return (<PageContainer>
      ...
      {selectedRowsState?.length > 0 && (<FooterToolbar extra={<div>
      ...
      <ModalForm title={intl.formatMessage({
      ...
      <Drawer width={600} open={showDetail} onClose={() => {
        ...
        {currentRow?.name && (<ProDescriptions column={2} title={currentRow?.name} request={async () => ({
                data: currentRow || {},
            })} params={{
                id: currentRow?.name,
            }} columns={columns}/>)}
