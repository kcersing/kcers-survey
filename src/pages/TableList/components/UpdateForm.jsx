...
const UpdateForm = (props) => {
    ...
    return (<StepsForm stepsProps={{
            ...
            return (<Modal width={640} bodyStyle={{ padding: '32px 40px 48px' }} destroyOnClose title={intl.formatMessage({
      ...
      <StepsForm.StepForm initialValues={{
        ...
        <ProFormTextArea name="desc" width="md" label={intl.formatMessage({
      ...
      <StepsForm.StepForm initialValues={{
        ...
        <ProFormSelect name="target" width="md" label={intl.formatMessage({
        ...
        <ProFormSelect name="template" width="md" label={intl.formatMessage({
        ...
        <ProFormRadio.Group name="type" label={intl.formatMessage({
      ...
      <StepsForm.StepForm initialValues={{
        ...
        <ProFormDateTimePicker name="time" width="md" label={intl.formatMessage({
        ...
        <ProFormSelect name="frequency" label={intl.formatMessage({
            id: 'pages.searchTable.updateForm.object',
            defaultMessage: '监控对象',
        })} width="md" valueEnum={{
            month: '月',
