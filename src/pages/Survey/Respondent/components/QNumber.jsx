...
const QNumber = (props) => {
  ...
  <ProFormDigit width="md" placeholder="请输入..." name={['question', question.id]} style={{ Width: 60 }} onChange={onChange} rules={[{ required: question.required === 1, message: '必填项' }]}/>
...
//# sourceMappingURL=QNumber.jsx.map