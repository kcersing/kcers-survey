...
import {
  FormInstance, ProFormCheckbox,
  ProFormColumnsType, ProFormDatePicker, ProFormDigit, ProFormRadio, ProFormRate, ProFormTextArea, ProFormUploadButton,
...
function toColumns(questions:API.Questions[]): [[], []] {

  let questionColumns: ProFormColumnsType[][]=[]
  let stepsArr=[]
