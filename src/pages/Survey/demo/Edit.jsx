...
const SurveyEdit = ({ match }) => {
    ...
    return (<ProForm form={form} layout="vertical" onFinish={onFinish} initialValues={{
            status: 'draft',
        }}>
      <ProFormText name="title" label="标题" rules={[{ required: true, message: '请输入问卷标题' }]}/>

      <ProFormText name="description" label="描述" textarea rows={4}/>
      ...
      <ProFormDatePicker name="start_time" label="开始时间" showTime/>

      <ProFormDatePicker name="end_time" label="结束时间" showTime/>
